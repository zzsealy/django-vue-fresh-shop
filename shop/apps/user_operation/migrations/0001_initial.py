# Generated by Django 2.2.2 on 2021-06-23 03:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('msg_type', models.IntegerField(choices=[(1, '留言'), (2, '投诉'), (3, '咨询'), (4, '售后'), (5, '求购')], default=1, help_text='留言类型:1(留言), 2(投诉), 3(询问), 4(售后), 5(求购)', verbose_name='留言类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('singer_name', models.CharField(default='', max_length=50, verbose_name='收货人姓名')),
                ('singer_mobile', models.CharField(default='', max_length=11, verbose_name='收货人手机号')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='用户')),
            ],
            options={
