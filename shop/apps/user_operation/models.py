...
class UserAddress(models.Model):
    ...
    singer_name = models.CharField(max_length=50, default='', verbose_name='收货人姓名')
    singer_mobile = models.CharField(max_length=11, default='', verbose_name='收货人手机号')
    add_time = models.DateTimeField(default=datetime.now, verbose_name='添加时间')
    ...
    def __str__(self):
        return '%s: %s' % (self.user.name, self.address)