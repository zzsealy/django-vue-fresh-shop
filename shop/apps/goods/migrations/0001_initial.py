# Generated by Django 2.2.2 on 2021-05-13 14:06

import datetime
from django.db import migrations, models
import django.db.models.deletion
import shop.extra_apps.DjangoUeditor.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_desc', shop.extra_apps.DjangoUeditor.models.UEditorField(default='', verbose_name='内容')),
                ('ship_free', models.BooleanField(default=True, verbose_name='是否承担运费')),
                ('good_front_image', models.ImageField(blank=True, null=True, upload_to='', verbose_name='首页大图')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(default='', help_text='类名code', max_length=20, verbose_name='类名code')),
