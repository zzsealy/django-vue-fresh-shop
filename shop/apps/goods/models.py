...
class GoodsCategory(models.Model):
    ...
    code = models.CharField(default="", max_length=20,
                            verbose_name="类名code", help_text="类名code")
...
class Goods(models.Model):
    ...
    category = models.ForeignKey(
        GoodsCategory, null=True, blank=True, verbose_name="商品类目", on_delete=models.CASCADE)
    ...
    market_price = models.FloatField(
        default=0, verbose_name="市场价格")  # 市场价格 应该是成本价
    ...
    ship_free = models.BooleanField(
        default=True, verbose_name="是否承担运费")  # 是否免运费
    good_front_image = models.ImageField(
        upload_to="", null=True, blank=True, verbose_name="首页大图")  # 首页大图
...
class GoodsImage(models.Model):
    ...
    image_url = models.CharField(
        max_length=300, null=True, blank=True, verbose_name="图片url")
    add_time = models.DateTimeField(default=datetime.now, verbose_name="添加时间")
